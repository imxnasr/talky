...
export const Chat: FC<ChatProps> = () => {
  ...
  return (
    <section className="flex flex-col flex-1">
      ...
      {/* Input */}
      <form onSubmit={sendMessage} className="flex text-colorSecondary justify-between items-center">
        <input className="bg-transparent size-full" type="text" name="message" placeholder="Your message" value={message} onChange={(e) => setMessage(e.target.value)} />
